    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('M', 'Mobile'), ('L', 'Laptop'), ('H', 'Home Appliances'), ('A', 'Accessories')], max_length=2)),
